...
async def start(bot, message):
    await message.reply(
        ...
        "I'm a specialised bot for shortening Droplink.co links which can help you earn money by just sharing links. Made by <a href=\"https://t.me/team_silent_king\">@team_silent_king</a>.")

@bot.on_message(filters.command('api') & filters.private)
async def start(bot, message):
    await message.reply(
        f"**Hi {message.chat.first_name}! Send Your Api Here 😉**\n\n"
        "Some Went Worng contact 👉 <a href=\"https://t.me/OFF_CHATS\">@team_silent_king</a>.")
...
async def link_handler(bot, message):
    ...
    for num in range(len(links)):
      try:
        ...
        await message.reply(f'**🔱 Long URL:** {links[num]}\n\n ** ⚜️ Shortened URL:** {short_link}\n\n〽️ Powered by <a href="https://t.me/team_silent_king\">@TEAM_SILENT_KING</a>', quote=True, disable_web_page_preview=True)
